import {
  __toModule,
  require_vue
} from "./chunk-4JWVVNW2.js";
import "./chunk-YXN4C27F.js";
...
function registerGuard(record, name, guard) {
  ...
  (0, import_vue.onUnmounted)(removeFromList);
  (0, import_vue.onDeactivated)(removeFromList);
...
function onBeforeRouteLeave(leaveGuard) {
  ...
  const activeRecord = (0, import_vue.inject)(matchedRouteKey, {}).value;
  if (!activeRecord) {
...
function useLink(props) {
  const router = (0, import_vue.inject)(routerKey);
  const currentRoute = (0, import_vue.inject)(routeLocationKey);
  const route = (0, import_vue.computed)(() => router.resolve((0, import_vue.unref)(props.to)));
  const activeRecordIndex = (0, import_vue.computed)(() => {
  ...
  const isActive = (0, import_vue.computed)(() => activeRecordIndex.value > -1 && includesParams(currentRoute.params, route.value.params));
  const isExactActive = (0, import_vue.computed)(() => activeRecordIndex.value > -1 && activeRecordIndex.value === currentRoute.matched.length - 1 && isSameRouteLocationParams(currentRoute.params, route.value.params));
  function navigate(e = {}) {
    if (guardEvent(e))
      return router[(0, import_vue.unref)(props.replace) ? "replace" : "push"]((0, import_vue.unref)(props.to));
    return Promise.resolve();
  }
  return {
    route,
    href: (0, import_vue.computed)(() => route.value.href),
    isActive,
    isExactActive,
    navigate
  };
}
var RouterLinkImpl = (0, import_vue.defineComponent)({
  name: "RouterLink",
  props: {
    to: {
      type: [String, Object],
  ...
  setup(props, {slots}) {
    const link = (0, import_vue.reactive)(useLink(props));
    const {options} = (0, import_vue.inject)(routerKey);
    const elClass = (0, import_vue.computed)(() => ({
    ...
    return () => {
      ...
      return props.custom ? children : (0, import_vue.h)("a", {
...
var RouterViewImpl = (0, import_vue.defineComponent)({
  name: "RouterView",
  inheritAttrs: false,
  props: {
    name: {
  ...
  setup(props, {attrs, slots}) {
    warnDeprecatedUsage();
    const injectedRoute = (0, import_vue.inject)(routerViewLocationKey);
    const routeToDisplay = (0, import_vue.computed)(() => props.route || injectedRoute.value);
    const depth = (0, import_vue.inject)(viewDepthKey, 0);
    const matchedRouteRef = (0, import_vue.computed)(() => routeToDisplay.value.matched[depth]);
    (0, import_vue.provide)(viewDepthKey, depth + 1);
    (0, import_vue.provide)(matchedRouteKey, matchedRouteRef);
    (0, import_vue.provide)(routerViewLocationKey, routeToDisplay);
    const viewRef = (0, import_vue.ref)();
    (0, import_vue.watch)(() => [viewRef.value, matchedRouteRef.value, props.name], ([instance, to, name], [oldInstance, from, oldName]) => {
      if (to) {
    ...
    return () => {
      ...
      const component = (0, import_vue.h)(ViewComponent, assign({}, routeProps, attrs, {
        onVnodeUnmounted,
        ref: viewRef
      }));
...
function addDevtools(app, router, matcher) {
  ...
  setupDevtoolsPlugin({
    ...
    (0, import_vue.watch)(router.currentRoute, () => {
      refreshRoutesView();
...
function createRouter(options) {
  ...
  const currentRoute = (0, import_vue.shallowRef)(START_LOCATION_NORMALIZED);
...
${JSON.stringify(newTargetLocation, null, 2)}
 when navigating to "${to.fullPath}". A redirect must contain a name or path. This will break in production.`);
  ...
  function handleScroll(to, from, isPush, isFirstNavigation) {
    ...
    return (0, import_vue.nextTick)().then(() => scrollBehavior(to, from, scrollPosition)).then((position) => position && scrollToPosition(position)).catch(triggerError);
  }
  ...
  const router = {
    ...
    install(app) {
      ...
      Object.defineProperty(app.config.globalProperties, "$route", {
        get: () => (0, import_vue.unref)(currentRoute)
      });
      ...
      for (let key in START_LOCATION_NORMALIZED) {
        reactiveRoute[key] = (0, import_vue.computed)(() => currentRoute.value[key]);
      }
      app.provide(routerKey, router2);
      app.provide(routeLocationKey, (0, import_vue.reactive)(reactiveRoute));
...
function useRouter() {
  return (0, import_vue.inject)(routerKey);
}
function useRoute() {
  return (0, import_vue.inject)(routeLocationKey);
}
export {
